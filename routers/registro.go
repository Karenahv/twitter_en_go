...
func Registro(w http.ResponseWriter, r *http.Request) {
	...
	if len(t.Password) < 6 {
		http.Error(w, "Debe específicar una contraseña de al menos 6 caracteres", 400)
		return
	}
	...
	if err != nil {
		http.Error(w, "Ocurrió un error al intentar realziar el registro de usuario "+err.Error(), 400)
		return
	}
	if status == false {
